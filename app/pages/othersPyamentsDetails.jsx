...
const styles = StyleSheet.create({
    ...
    amountDetails: { borderWidth: 1, marginTop: 10, paddingHorizontal: 20, paddingVertical: 17, borderRadius: 17, borderColor: "rgba(0,0,0,0.03)", backgroundColor: "rgba(255,255,255,0.7)", marginBottom: 2, borderStyle: 'dashed' },
    ...
    paymentContainer: { marginTop: 20, borderRadius: 5, backgroundColor: '#ffffff',},
    payment: { marginVertical: 10, paddingVertical: 5 },
    paymentText: { fontSize: 18, marginBottom: 5, fontWeight: '500', paddingHorizontal:10 },
